      ...
      <div>
          ...
          <div className=" " style={{ backgroundImage: `url("https://edmy-react.hibootstrap.com/images/banner/banner-bg.jpg")` }}>
              ...
              <div className="md:w-[50%]">
                  <div className="bg-[#addcc4] p-[20px] h-[350px] sm:h-[600px] md:h-[500px] lg:h-[600px] xl:h-[700px] rounded-[100%]">
                      <img className='h-[250px] sm:h-[500px] md:h-[400px] lg:h-[500px] xl:h-[600px]' src="https://edmy-react.hibootstrap.com/images/banner/banner-img-1.png" alt="" />
                  </div>
              </div>
