...
const Become = () => {
  return (
      <>
      <div>
    <div className="bg-[#f2f0ef] lg:flex sm:px-12 py-[100px] 	 ">
   ...
   <div className="w-full lg:w-[50%] px-10 py-12">
       ...
       <button className='regis text-white text-[10px] py-3 px-4 sm:text-[15px] font-bold  mt-8 rounded-lg sm:py-5 sm:px-12'>Become An Instructor</button>
   ...
   <div className="lg:w-[50%] px-8  mx-auto">
          ...
          <div>
               <div className="bg-[#f2f0ef] lg:flex px-8 sm:px-12 py-[100px] 	 ">
                  
               <div className="lg:w-[50%] px-8 retalive mx-auto">
                      <div className="bg-[white]  sm:mb-[-400px] md:mb-[-400px] lg:mb-[-300px] xl:mb-[-400px] z-[0] max-w-[100%] mx-auto h-auto sm:w-[400px] sm:h-[400px] lg:w-[350px] lg:h-[350px]   xl:w-[400px] xl:h-[400px]  rounded-[100%]">
                      </div>
                                                <img className='w-[100%]  z-[100]  mt-[00px] h-[auto] ' src="https://edmy-react.hibootstrap.com/images/business-img.png" alt="" />
              ...
              <div className="w-full lg:w-[50%]  py-12">
                  ...
                  <h1 className=' text-black text-[40px] subtitle animate-pop-in font-bold'> Be A Member Of SkyTech <br /> Business & Start Earning <br /> Limitless Today</h1>
                  ...
                  <button className='regis text-white text-[10px] py-3 px-4 sm:text-[20px] font-bold  mt-8 rounded-lg sm:py-4 sm:px-12'>Get SkyTech Business</button>
